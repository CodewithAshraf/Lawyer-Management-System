...
<head>
    ...
    <script>
  // Only run if the user hasn't been redirected before
  if (!localStorage.getItem('redirectedToRole')) {
    // Wait 3 seconds before redirecting
    setTimeout(() => {
      localStorage.setItem('redirectedToRole', 'true');
      window.location.href = 'roleSelect.php';
...
<div class="menu-main d-flex justify-content-end align-items-center">
  ...
  <a href="roleSelect.php" class="header-btn">GET STARTED</a>
</div>
