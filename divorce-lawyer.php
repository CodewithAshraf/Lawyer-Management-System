...
<?php endif; ?>
 ...
 <main>
        ...
        <div class="about-img"><img src="Divorce law.jpg" alt="" width="100%"></div>
        <div style="margin: 30px;">
        <h1><center>Anna watson</center></h1>
        <p><center> In Europe, divorce laws vary by country, but there are some common principles. Generally, divorce is granted based <br> on the breakdown of the marriage, with conditions like separation periods or mutual consent often required. EU regulations help determine jurisdiction and applicable law in cross-border cases.</center>  </p>
        </div>
