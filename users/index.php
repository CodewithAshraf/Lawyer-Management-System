...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
     <script>
    if (!localStorage.getItem('userRedirectedOnce')) {
      setTimeout(() => {
        localStorage.setItem('userRedirectedOnce', 'true');
...
@media (max-width: 1200px) {
  ...
  .dashboard-btn { padding: 6px 18px; font-size: 15px; }
  .profile-name { font-size: 14px; }
}
@media (max-width: 992px) {
  .logo img { max-height: 45px; }
  .dashboard-btn { padding: 5px 16px; font-size: 14px; }
  .profile-name { display: none; }
}
@media (max-width: 768px) {
  .logo img { max-height: 40px; }
  .dashboard-btn { padding: 5px 14px; font-size: 13px; }
  .dropdown-toggle img { width: 32px; height: 32px; }
}
@media (max-width: 576px) {
  .logo img { max-height: 36px; }
  .dashboard-btn { padding: 4px 12px; font-size: 12px; }
  .dropdown-toggle img { width: 30px; height: 30px; }
}
@media (max-width: 400px) {
  .dashboard-btn { padding: 3px 10px; font-size: 11px; }
  .dropdown-toggle img { width: 28px; height: 28px; }
}
...
<!-- Optional: Redirect Script (Once Only) -->
<script>
  if (!localStorage.getItem('userRedirectedOnce')) {
    setTimeout(() => {
      localStorage.setItem('userRedirectedOnce', 'true');
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="health-law.php">Health Law </a></h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="insurance-law.php">Insurance Law</a></h5>
                            <p>Sorem hpsum folor sixdsft amhtget, consectetur adipiscing eliht, sed do eiusmod tempor incidi.</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="vehical-accident law.php">Vehicle Accident </a></h5>
                            <p>Sorem hpsum folor sixdsft amhtget, consectetur adipiscing eliht, sed do eiusmod tempor incidi.</p>
        ...
        <div class="about-details">
            <div class="right-caption">
                ...
                <div class="about-more">
                    ...
                    <a href="about.php" class="btn post-btn">Learn About Us</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            ...
                            <div class="blog-cap">
                                <h3><a href="blog_details.php">16 Easy Ideas to Use in Our Everyday
