...
<?php endif; ?>
 ...
 <main>
        ...
        <div class="about-img"><img src="insurance law.jpg" alt="" width="100%"></div>
        <div style="margin: 30px;">
        <h1><center>Benjamin</center></h1>
        <p><center>Insurance law governs the practice of insurance, encompassing the regulations surrounding insurance companies, the content of insurance policies, and the handling <br> of insurance claims. It includes both the rules for companies operating within the insurance industry and the legal framework for insurance contracts and disputes.</center>   </p>
        </div>
