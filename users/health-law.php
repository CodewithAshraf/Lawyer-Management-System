...
<?php endif; ?>
 ...
 <main>
        ...
        <div class="bout-imga"><img src="health law.jpg" alt="" width="100%"></div>
        <div class="area" style="margin: 30px;">
        <h1><center>James</center></h1>
        <p> <center> Health law encompasses the rules and regulations that govern the healthcare system and the health <br> of individuals and populations. It covers a wide range of topics, from the provision of healthcare  services to the <br> regulation of drugs and  medical devices, and the promotion of public health initiatives. Health law also <br> addresses ethical considerations in healthcare, such as  informed consent and patient confidentiality.</center> </p>
        </div>
    ...
    <a href="appointment.php" class="header-btn">BOOK AN APPOINTMENT</a>
<?php else: ?>
    <a href="#"  class="header-btn" id="hh" onclick="alert('Please sign in to book an appointment.')">BOOK AN APPOINTMENT</a>
<?php endif; ?>
