...
<main>
        ...
        <div class="about-img"><img src="car accident lawyer.jpg" alt="" width="100%"></div>
        <div style="margin: 30px;">
       <h1><center>Goerge Jack</center></h1>
        <p><center> Car accident laws address both criminal and civil aspects of such incidents. <br> Criminal law focuses on penalties for negligent or reckless driving, while civil law allows for compensation claims from victims or their families. <br> Key areas include proving negligence, determining liability, and the process <br> for seeking compensation under the Fatal Accidents Act or through civil suits.</center> </p>
        </div>
