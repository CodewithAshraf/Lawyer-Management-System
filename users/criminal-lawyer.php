    ...
    <nav>
      <ul id="navigation">
        ...
        <li><a class="links" href="about.html">About</a></li>
         ...
         <li><a class="links" href="">Services</a>
        <ul class="submenu">
    ...
    <div class="nav-item dropdown">
      <a href="#" class="nav-link dropdown-toggle d-flex align-items-center gap-2" data-bs-toggle="dropdown">
        ...
        <span class="d-none d-lg-inline-flex">
          <?php if (isset($_SESSION['users'])) { echo $_SESSION['users']; } ?>
        </span>
      </a>
...
<main>
        ...
        <div class="about-img"><img src="criminal law.jpg" alt="" width="100%"></div>
        <div style="margin: 30px;">
        <h1><center>Robert Hillson</center></h1>
        <p><center> Criminal law is a body of rules and statutes defining conduct prohibited by the state <br> because it threatens public safety and welfare, and establishing the corresponding punishment for those acts. <br> It encompasses the definition of crimes, the procedures for investigating and prosecuting alleged offenders, and the penalties imposed on those found guilty. </center></p>
        </div>
