...
<head>
  ...
  if (!localStorage.getItem('lawyerRedirectedOnce')) {
    // Wait 3 seconds then redirect
    setTimeout(() => {
      localStorage.setItem('lawyerRedirectedOnce', 'true'); // Set flag
      window.location.href = "lawyerSignin.php";
    }, 5000);
  }
</script>
