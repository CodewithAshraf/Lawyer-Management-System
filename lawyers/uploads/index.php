...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Insert into DB
    $query = "INSERT INTO `lawyer`( `username`, `email`, `password`, `ProfileImage`, `Specialization`)
     VALUES ('$username','$email','$password','$image','$specialization')";
    mysqli_query($conn,$query);
                                                                                
   

    // header( " Location: health-law.php");

    echo "<script>window.location.href = 'lawyerSignin.php';</script>";
exit;
}
?>
...
<?php else: ?>
    <a href="Signin.php" class="header-btn" onclick="alert('Please sign in to book an appointment.')">BOOK AN APPOINTMENT</a>
<?php endif; ?>
